...
class DecimalSymbolConversion(DirectInput):
    ...
    def _get_possible_results(self, number_of_digits: int, function: callable, remove_min_processed_digit: bool,
                              reverse: bool, step: int = 1, only_odd_digits: bool = False) -> dict:
        results = {}
    ...
    @staticmethod
    def _get_processed_digits(number: int, function: callable, step: int = 1) -> list:
